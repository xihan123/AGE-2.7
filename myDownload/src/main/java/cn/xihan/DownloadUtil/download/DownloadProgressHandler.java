package cn.xihan.DownloadUtil.download;
...
import static cn.xihan.DownloadUtil.data.Consts.CANCEL;
import static cn.xihan.DownloadUtil.data.Consts.DESTROY;
import static cn.xihan.DownloadUtil.data.Consts.ERROR;
import static cn.xihan.DownloadUtil.data.Consts.FINISH;
import static cn.xihan.DownloadUtil.data.Consts.NONE;
import static cn.xihan.DownloadUtil.data.Consts.PAUSE;
import static cn.xihan.DownloadUtil.data.Consts.PROGRESS;
import static cn.xihan.DownloadUtil.data.Consts.START;


/**
 * @项目名 : AGE动漫
 * @作者 : MissYang
 * @创建时间 : 2021/3/10 14:03
 * @介绍 :
 */
